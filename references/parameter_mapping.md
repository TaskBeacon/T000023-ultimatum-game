...
| `timing.cue_duration` | `0.5` | `W2115247350` | `inferred` | Short pre-offer cue for phase separation in trigger-aligned pipelines. |
| `timing.anticipation_duration` | `0.6` | `W2115247350` | `inferred` | Pre-decision fixation interval to isolate offer-response stage onset. |
| `timing.offer_duration` | `2.0` | `W2115247350`, `W2147965914` | `inferred` | Fixed response window for accept/reject decision capture. |
| `timing.decision_feedback_duration` | `0.6` | `W2115247350` | `inferred` | Brief confirmation before payoff stage. |
| `timing.feedback_duration` | `1.0` | `W2115247350`, `W2147965914` | `inferred` | Dedicated payoff display for outcome encoding and cumulative tracking. |
...
| `triggers.map.{condition}_cue_onset` | `20/21/22` | `inferred` | `inferred` | Condition-specific cue encoding for downstream event parsing. |
| `triggers.map.{condition}_anticipation_onset` | `23/24/25` | `inferred` | `inferred` | Condition-specific pre-decision fixation encoding. |
| `triggers.map.{condition}_offer_onset` | `30/31/32` | `inferred` | `inferred` | Condition-specific offer decision onset encoding. |
...
| `triggers.map.decision_feedback_onset` | `52` | `inferred` | `inferred` | Decision confirmation onset marker. |
